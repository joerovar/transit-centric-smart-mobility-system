...
FOCUS_START_TIME_SEC = 26400
FOCUS_END_TIME_SEC = 28860
...
[IDX_ARR_T, IDX_DEP_T, IDX_LOAD, IDX_PICK, IDX_DROP, IDX_DENIED] = [i for i in range(1, 7)]
# only for even headway strategy
IDX_HOLD_TIME = 7
# only for deep RL
IDX_SKIPPED = 8
...
# C_REW_HW_HOLD = 0.995
# C_REW_HW_SKIP = 0.9995
# C_REW_PAX_HOLD = 1 - C_REW_HW_HOLD
# C_REW_PAX_SKIP = 1 - C_REW_HW_SKIP
CONTROLLED_STOPS = ['390', '395', '14959', '14500', '413', '16110', '425', '431', '16049']
LIMIT_HOLDING = 40
