...
# route
FULL_PATTERN_HEADSIGN = 'Wilson/Marine'
RT_NR = 81
OB_DIRECTION = 'East'
IB_DIRECTION = 'West'
...
BOARDING_TIME = 2.8
ALIGHTING_TIME = 1.9
DWELL_TIME_ERROR = 4.5
EXTREME_TT_BOUND = 1.0
BOOST_SCHED_RUN_T = 1.2 # FOR THOSE PROBLEMATIC LINKS (FIRST AND LAST) INCREASE SCHED RUN TIME BY 30 PCT
DEP_DELAY_FROM = -60
DEP_DELAY_TO = 100
...
WEIGHT_HOLD_T = 0.0
BW_H_LIMIT_EXPRESS = 0.3 # this is the limit over the scheduled backward headway to decide to express
FW_H_LIMIT_EXPRESS = 1.6 # this is the limit over the scheduled forward headway to decide to express
