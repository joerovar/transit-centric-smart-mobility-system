import output
from simulation_env import SimulationEnv, SimulationEnvWithControl, DetailedSimulationEnv, DetailedSimulationEnvWithControl
...
def run_base_control_detailed(episodes=1, save=False, plot=False, time_dep_tt=True, time_dep_dem=True):
    tstamps = []
    for i in range(episodes):
...
run_base_detailed(save=True, plot=True)
